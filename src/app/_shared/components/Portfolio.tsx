            ...
            <LeftGridContainer>
                <BasicProfileColumn>
                    ...
                    <ContactSection>
                        <ContactItem>
                            ...
                            <ContactValue>
                                {bunnyDetail?.spec.email}
                            </ContactValue>
                        </ContactItem>
                        <ContactItem>
                            <ContactLabel>Link</ContactLabel>
                            <SocialIcons>
                                {bunnyDetail?.spec.link &&
                                    bunnyDetail.spec.link.length > 0 &&
                                    bunnyDetail.spec.link.map((link, index) => {
                                        const iconSrc = getLinkIcon(
                ...
                <DetailedProfileColumn>
                    <ExperienceSection>
                        <SectionHeader>
                            <SectionImage
                                src="/images/personal/funding/company.png"
                                alt="경력"
                            />
                            <SectionTitle>경력</SectionTitle>
                            <SectionLine />
                        </SectionHeader>
                        {bunnyDetail?.spec.career &&
                            bunnyDetail.spec.career.length > 0 &&
                    ...
                    <EducationSection>
                        <SectionHeader>
                            <SectionImage
                                src="/images/personal/funding/education.png"
                                alt="학력"
                            />
                            <SectionTitle>학력</SectionTitle>
                            <SectionLine />
                        </SectionHeader>
                        {bunnyDetail?.spec.education &&
                            bunnyDetail.spec.education.length > 0 &&
                            bunnyDetail.spec.education.map(
                                (education, index) => (
                    ...
                    <CertificationSection>
                        <SectionHeader>
                            <SectionImage
                                src="/images/personal/funding/certification.png"
                                alt="자격증"
                            />
                            <SectionTitle>자격증</SectionTitle>
                            <SectionLine />
                        </SectionHeader>
                        {bunnyDetail?.spec.certification &&
                            bunnyDetail.spec.certification.length > 0 &&
                            bunnyDetail.spec.certification.map(
                                (certification, index) => (
                    ...
                    <TechStackSection>
                        <SectionHeader>
                            <SectionImage
                                src="/images/personal/funding/stack.png"
                                alt="기술스택"
                            />
                        ...
                        <TechStackGrid>
                            {bunnyDetail?.spec.skill &&
                                bunnyDetail.spec.skill.length > 0 &&
